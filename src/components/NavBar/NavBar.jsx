  ...
  return (
    <div className="navbar sticky top-0 z-50 backdrop-blur-xl bg-zinc-950/70 border-b border-white/5 shadow-[0_4px_30px_rgba(0,0,0,0.1)] px-4">
      <div className="navbar-start">
        <a className="flex items-center gap-3 text-2xl font-bold tracking-tighter hover:scale-105 transition-transform cursor-pointer">
          <div className="relative">
            <div className="absolute inset-0 bg-cyan-500 blur-md opacity-20 rounded-full"></div>
            <img className="w-10 relative z-10 brightness-150 drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]" src={logo} alt="Logo" />
          </div>
